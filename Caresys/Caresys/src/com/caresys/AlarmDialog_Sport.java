...
import com.caresys.Menu_v1;

public class AlarmDialog_Sport extends Activity {
	...
	private void viewCategory() {
		...
		viewDialog.setPositiveButton("延遲",new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int whichButton) {
				...
				Intent intent = new Intent(AlarmDialog_Sport.this,AlarmReceiver.class);
				intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
				intent.putExtra("title", Title);
				PendingIntent sender = PendingIntent.getBroadcast(AlarmDialog_Sport.this, 4, intent, PendingIntent.FLAG_ONE_SHOT);
		...
		viewDialog.setNegativeButton("記錄",new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int whichButton) {
				Intent intent = new Intent(AlarmDialog_Sport.this,Menu_v1.class);
