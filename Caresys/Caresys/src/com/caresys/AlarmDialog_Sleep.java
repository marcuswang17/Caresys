...
public class AlarmDialog_Sleep extends Activity {
	...
	private void viewCategory() {
		...
		viewDialog.setPositiveButton("延遲",new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int whichButton) {
				...
				Intent intent = new Intent(AlarmDialog_Sleep.this,AlarmReceiver.class);
				intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
				intent.putExtra("title", Title);
				PendingIntent sender = PendingIntent.getBroadcast(AlarmDialog_Sleep.this, 4, intent, PendingIntent.FLAG_ONE_SHOT);
		...
		viewDialog.setNegativeButton("記錄",new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int whichButton) {
        		...
        		intent.setClass(AlarmDialog_Sleep.this, SleepService.class);
        		startService(intent);
        		
        		Intent intent2 = new Intent(AlarmDialog_Sleep.this,Menu_v1.class);
